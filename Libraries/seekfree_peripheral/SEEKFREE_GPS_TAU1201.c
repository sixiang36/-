...
//    return angle>0?angle:angle+360;   逐飞原始返回值为0-360
		return angle;
}
...
void gps_init(void)
{
   ...
   uart_init(GPS_TAU1201_UART, 115200, GPS_TAU1201_RX, GPS_TAU1201_TX);    //逐飞原始值为115200
		
//		uart_init(GPS_TAU1201_UART,9600, GPS_TAU1201_RX, GPS_TAU1201_TX);   //适用于维特智能GPS
